...
const DisplayOne = ({style}) => {
    return(
       ...
       {/* <div className={style["Rectangle-1632"]}>
         <div className={style["Throughtput"]}>
              Throughtput
              <div className={style['row']}>
                  <div className={style['col']}>
                      12,345oz
                      <div  className={style['Trailing-30-days']}>trailing 30-days</div>
                  </div>
                  <div className={style['col']}>
                      <div className={style['sub-row']}>
                            <div className={style['sub-col']}>
                                <div  className={style['Prior-30-Days']}>Prior 30 Days</div>
                                <div  className={style['percentage']}> -1.5%</div>
                            </div>
                            <div className={style['sub-col']}>
                                <div  className={style['Polygon-15']}>
                                <img src={Polygon15}
...
//           </div>
//           <div className={style["Rectangle-1632"]}>
//             <div className={style["Inventory-Dollars-Daily-Average"]}>
//                 Inventory Dollars
//                 </div>
//           </div>
//           <div className={style["Rectangle-1632"]}>
//             <div className={style["Inventory-Turns"]}>
//               Inventory Turns
//             </div>
//           </div>
//        </>
